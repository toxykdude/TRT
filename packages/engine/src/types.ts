...
// Generated by the AI dosing engine (packages/ai/src/dosing.ts) — exact steroid
// + ancillary dosages based on deterministic findings + KB/graph enrichment.

export type DosingRecommendation = {
  /** compound name (display) */
  compound: string;
  /** recommended dose with unit, e.g. "100–200 mg" */
  dose: string;
  ...
  ragSourceIds: string[];
  /** priority level for the clinician */
...
export type DeterministicReport = {
  ...
  hash: string;
  /** steroid + ancillary dosing recommendations (populated by AI dosing engine) */
